...
const AddProduct: React.FC = () => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            await axios.post(`${import.meta.env.VITE_REACT_API_URI}/product/addproducts`, { products }, {
                headers: {
    ...
    const handleGeneratePDF = async () => {
        ...
        try {
            const token = localStorage.getItem('token');
            const response = await axios.get(`${import.meta.env.VITE_REACT_API_URI}/product/invoices/${urlId}`, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
                responseType: 'blob',
